  ...
  getQuantityFormat({value}){
    ...
    try{
      if(value.item_sum is double){
        returnValue = '${value.item_qty.toString()}/${double.parse(value.item_sum.toString()).toStringAsFixed(3)}(${value.unit})';
      } else {
        ...
        build: (context) {
          return pw.Column(
            ...
            children: [
              ...
              pw.Spacer(),
              pw.Center(
                child: pw.Text('${branchObject['name']}', style: pw.TextStyle(font: getFontFormat(branchObject['name']), fontSize: 40))
              ),
              pw.Spacer(),
              pw.Center(
        ...
        build: (context) {
          return pw.DefaultTextStyle(
            ...
            child: pw.Column(
                crossAxisAlignment: pw.CrossAxisAlignment.start,
                children: [
                  pw.Text('Payment Overview', style: pw.TextStyle(fontSize: 10)),
                  pw.SizedBox(height: 10),
                  pw.Table.fromTextArray(
                      ...
                      data: List.generate(
                          payment.length,
                            ...
                            (payment[index]['total_amount'] as num).toStringAsFixed(2)
                                
                          ])),
                  pw.SizedBox(height: 50),
                  charges.isNotEmpty ?
                  pw.Text('Charges Overview', style: pw.TextStyle(fontSize: 10)) : pw.Text(''),
                  pw.SizedBox(height: 10),
                  charges.isNotEmpty ?
                  pw.Table.fromTextArray(
                      border: null,
                      ...
                      data: List.generate(
                          charges.length,
                              (index) => [
                            charges[index]['name'],
                            (charges[index]['total_amount'] as num).toStringAsFixed(2)
                          ]))
                      :
                  pw.Text('')
                ]
              ...
              child: pw.Column(
                  ...
                  children: [
                    pw.Row(
                      ...
                      children: [
                        pw.Text('Sales Summary Report'),
                        pw.Text('${branchObject['name']}', style: pw.TextStyle(font: getFontFormat(branchObject['name']))),
                      ],
                    ),
                    pw.Divider(),
                    pw.Text('Date: ${reportModel.startDateTime2.toString()} - ${reportModel.endDateTime2.toString().split(' ')[0]}'),
                    pw.Text('Printed At: ${DateFormat('dd-MM-yyyy hh:mm:ss a').format(DateTime.now())}'),
                  ]
              ),
            );
          },
                        ...
                        children: [
                          pw.TableRow(
                              ...
                              children: [
                                ...
                                pw.Padding(
                                  padding: pw.EdgeInsets.fromLTRB(10, 5, 10, 5),
                                  child: pw.Text('Total Rounding', style: pw.TextStyle(color: PdfColors.white, fontWeight: pw.FontWeight.bold, font: getFontFormat('Total Tax'))),
                                ),
                                pw.Padding(
                                  padding: pw.EdgeInsets.fromLTRB(10, 5, 10, 5),
                          ...
                          for(int j = 0; j < valueList.length; j++)
                            pw.TableRow(
                                children: [
                                  ...
                                  pw.Padding(
                                    padding: pw.EdgeInsets.fromLTRB(5, 5, 10, 5),
                                    child: pw.Text('${valueList[j].all_rounding_amount?.toStringAsFixed(2)}', style: pw.TextStyle(font: getFontFormat(valueList[j].all_rounding_amount?.toStringAsFixed(2)))),
                                  ),
                                  pw.Padding(
                                    padding: pw.EdgeInsets.fromLTRB(5, 5, 10, 5),
              ...
              child: pw.Column(
                  ...
                  children: [
                    pw.Row(
                      mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                      children: [
                        pw.Text('Product Modifier Report'),
                        pw.Text('${branchObject['name']}', style: pw.TextStyle(font: getFontFormat(branchObject['name']))),
                      ],
                    ),
                    pw.Divider(),
                        ...
                        children: [
                          pw.TableRow(
                              ...
                              children: [
                                ...
                                pw.Padding(
                                  padding: pw.EdgeInsets.fromLTRB(5, 10, 10, 10),
                                  child: pw.Text('Orig Price', style: pw.TextStyle(color: PdfColors.white, fontWeight: pw.FontWeight.bold, font: getFontFormat('Original Price'))),
                                ),
                                pw.Padding(
                                  padding: pw.EdgeInsets.fromLTRB(5, 10, 10, 10),
                          ...
                          // for(int i = 0; i < valueList[j].categoryOrderDetailList.length; i++)
                            pw.TableRow(
                                children: [
                                  pw.Padding(
                                    padding: pw.EdgeInsets.fromLTRB(5, 5, 10, 5),
                                    child: pw.Text('#${valueList[j].categoryOrderDetailList[j].order_number}',
              ...
              child: pw.Column(
                  ...
                  children: [
                    pw.Row(
                      mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                      children: [
                        pw.Text('Cancelled Modifier Report'),
                        pw.Text('${branchObject['name']}', style: pw.TextStyle(font: getFontFormat(branchObject['name']))),
                      ],
                    ),
                    pw.Divider(),
              ...
              child: pw.Column(
                  ...
                  children: [
                    pw.Row(
                      mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                      children: [
                        pw.Text('Staff Attendance Report'),
                        pw.Text('${branchObject['name']}', style: pw.TextStyle(font: getFontFormat(branchObject['name']))),
                      ],
                    ),
                    pw.Divider(),
