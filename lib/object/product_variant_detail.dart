...
class ProductVariantDetail {
  ...
  static ProductVariantDetail fromJson(Map<String, Object?> json) => ProductVariantDetail(
    product_variant_detail_id: json[ProductVariantDetailFields.product_variant_detail_id] as int?,
    product_variant_id: json[ProductVariantDetailFields.product_variant_id] as String?,
    variant_item_id: json[ProductVariantDetailFields.variant_item_id] as String?,
  ...
  Map<String, Object?> toJson() => {
    ProductVariantDetailFields.product_variant_detail_id: product_variant_detail_id,
