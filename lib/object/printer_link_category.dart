...
class PrinterLinkCategoryFields {
  ...
  static String printer_link_category_key = 'printer_link_category_key';
...
class PrinterLinkCategory {
  ...
  String? printer_link_category_key;
  ...
  PrinterLinkCategory(
      {this.printer_link_category_sqlite_id,
        this.printer_link_category_key,
  ...
  PrinterLinkCategory copy({
    ...
    String? soft_delete
      ...
      PrinterLinkCategory(
          ...
          printer_link_category_key: printer_link_category_key ?? this.printer_link_category_key,
  ...
  static PrinterLinkCategory fromJson(Map<String, Object?> json) => PrinterLinkCategory(
    ...
    printer_link_category_key:  json[PrinterLinkCategoryFields.printer_link_category_key] as String?,
    ...
    printer_key: json[PrinterLinkCategoryFields.printer_key] as String?,
  ...
  Map<String, Object?> toJson() => {
    ...
    PrinterLinkCategoryFields.printer_link_category_key: printer_link_category_key,
    ...
    PrinterLinkCategoryFields.printer_key: printer_key,
