...
class _PaymentSuccessDialogState extends State<PaymentSuccessDialog> {
  ...
  callOpenCashDrawer() async {
    int printStatus =
        await PrintReceipt().cashDrawer(printerList: this.printerList);
    if (printStatus == 1) {
      ...
      if (orderData.length == 1) {
        if(orderData[0].payment_link_company_id != '0') {
          CashRecord cashRecordObject = CashRecord(
              ...
              payment_name: '',
              payment_type_id: orderData[0].payment_type_id,
              type: 3,
          ...
          CashRecord cashRecordObject = CashRecord(
              ...
              payment_name: '',
              payment_type_id: splitOrderData[0].payment_type_id,
              type: 3,
              user_id: userObject['user_id'].toString(),
              settlement_key: '',
              settlement_date: '',
