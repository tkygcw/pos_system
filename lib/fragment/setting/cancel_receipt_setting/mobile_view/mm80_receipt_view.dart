...
class mm80MobileReceiptView extends StatefulWidget {
  final Function(CancelReceipt layout) callback;
  const mm80MobileReceiptView({Key? key, required this.callback}) : super(key: key);

  @override
  State<mm80MobileReceiptView> createState() => _mm80MobileReceiptView();
}

class _mm80MobileReceiptView extends State<mm80MobileReceiptView> {
