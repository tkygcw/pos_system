...
*/
  printCombinedKitchenList80mm(bool isUSB, int localId, {value, required List<OrderDetail> orderDetailList, bool? isReprint, double? combineListTotal, String? printerLabel}) async {
...
*/
  printCombinedKitchenList58mm(bool isUSB, int localId, {value, required List<OrderDetail> orderDetailList, bool? isReprint, double? combineListTotal, String? printerLabel}) async {
    List<cartProductItem> cartItemList = [];
    final prefs = await SharedPreferences.getInstance();
    final int? branch_id = prefs.getInt('branch_id');
