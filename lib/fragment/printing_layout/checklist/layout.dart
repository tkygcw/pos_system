  ...
  printCheckList80mm(bool isUSB, int localId, {value, isQrOrder, String? order_by, int? printer_id}) async {
    ...
    if(orderDetailList.isNotEmpty){
      ...
      try {
        ...
        bytes += generator.text(printer_id != null && printer_id != 0 ? '** KITCHEN CHECKLIST **' : '** ORDER LIST **', styles: PosStyles(align: PosAlign.center, height:PosTextSize.size2, width: PosTextSize.size2 ));
