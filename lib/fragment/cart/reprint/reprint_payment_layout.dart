...
class ReprintPaymentLayout extends ReceiptLayout{
  /*
  Receipt layout 80mm
*/
  reprintPaymentReceipt80mm(bool isUSB, String orderId, List<String> tableNumberList, {value, isRefund}) async {
    ...
    try {
      ...
      if(tableNumberList.isNotEmpty){
        bytes += generator.text('Table No: ${tableNumberList.toString().replaceAll('[', '').replaceAll(']', '')}');
      }
...
*/
  reprintPaymentReceipt58mm(bool isUSB, String orderId, List<String> tableNumberList, {value, isRefund}) async {
    ...
    try {
      ...
      if(tableNumberList.isNotEmpty){
        bytes += generator.text('Table No: ${tableNumberList.toString().replaceAll('[', '').replaceAll(']', '')}', styles: PosStyles(align: PosAlign.center));
      }
