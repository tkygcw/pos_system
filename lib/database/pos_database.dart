...
class PosDatabase {
  ...
  Future<Database> _initDB(String filePath) async {
    ...
    return await openDatabase(path, version: 39, onCreate: PosDatabaseUtils.createDB, onUpgrade: PosDatabaseUtils.onUpgrade, singleInstance: Platform.isWindows ? false : true);
  }
